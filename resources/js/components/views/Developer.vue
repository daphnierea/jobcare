            ...
            >
                <v-col cols="12" md="8">
                    <v-row class="mt-12">
                        ...
                        <p class="">
                            To start, <a href="/signup">Sign-up</a> for free.
                        </p>
                        <!-- <p class="">
                        ...
                        <pre><code class="HTTP p-3 mb-0 hljs"><span class="hljs-attribute">JobCare-ApiKey</span>: {PROJECT_API_KEY}</code></pre>
                        <p class="">Body:</p>
                        <table
...
<span class="hljs-meta">&lt;?php</span>
        ...
        CURLOPT_HTTPHEADER =&gt; <span class="hljs-keyword">array</span>(
            ...
            <span class="hljs-string">"JobCare-ApiKey: your-own-api-key"</span>
            ),
        ));
...
<span class="hljs-keyword">var</span> options = {
  ...
  <span class="hljs-string">'headers'</span>: {
    ...
    <span class="hljs-string">'JobCare-ApiKey'</span>: your-own-api-key
  }
};
...
request[<span class="hljs-string">"JobCare-ApiKey"</span>] = your-own-api-key
...
<span class="hljs-keyword">var</span> headers = {
  ...
  <span class="hljs-string">"JobCare-ApiKey"</span>: <span class="hljs-string">"your-own-api-key"</span>
};
